...
configure :build do
  ...
  # Enable cache buster
  activate :asset_hash, ignore: 'favicon.png|open_graph.jpg|apple-touch-icon.png|phone_loading.png|plain_loading.png|images/role/|images/phoodie/|images/profile/|images/nbu/'
